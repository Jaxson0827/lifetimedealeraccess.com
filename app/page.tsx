  ...
  return (
    <main className="bg-navy-dark">
      ...
      >
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-8 lg:px-16 pt-14 lg:pt-20 pb-10 lg:pb-14">
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center mb-8 lg:mb-10">
            ...
            <div className="max-w-[600px] lg:max-w-[650px]">
              ...
              <h1 className="text-white text-[34px] lg:text-[42px] xl:text-[46px] leading-[1.08] tracking-[-0.03em] mb-5">
              ...
              {/* Subheadline */}
              <p className="text-white text-[17px] lg:text-[19px] xl:text-[21px] font-normal leading-snug mb-5">
                with a dedicated buying consultant guiding every step.
              </p>

              {/* Supporting Copy */}
              <p className="text-white/70 text-[15px] lg:text-[16px] leading-relaxed mb-6">
              ...
              <a
                href="/get-started"
                className="inline-block bg-cta-red text-white text-[14px] lg:text-[15px] font-semibold px-6 lg:px-7 py-3.5 lg:py-4 rounded-[6px] mb-4 hover:bg-red-700 transition-colors duration-200"
              >
                Get Started
              </a>

              {/* Trust Line */}
              <p className="text-white/50 text-[13px] lg:text-[14px]">
            ...
            <div
              className="relative h-[300px] lg:h-[380px] xl:h-[450px] overflow-hidden rounded-tl-[60px] rounded-br-[60px] rounded-tr-[20px] rounded-bl-[20px] ring-1 ring-white/15"
              style={{
          ...
          <div className="max-w-[1200px] mx-auto">
            {/* Headline */}
            <h2 className="text-white text-[22px] lg:text-[26px] xl:text-[30px] font-bold text-center mb-8 lg:mb-10">
            ...
            <div className="w-full max-w-[800px] mx-auto h-px bg-gradient-to-r from-transparent via-white/20 to-transparent mb-8" />

            {/* Descriptive Text */}
            <p className="text-white/70 text-[14px] lg:text-[15px] leading-relaxed text-center max-w-[700px] mx-auto">
      ...
      <section id="about" className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-8 lg:px-16">
          ...
          <h2 className="text-[42px] lg:text-[48px] xl:text-[52px] font-serif text-center mb-4">
          ...
          {/* Subheadline */}
          <p className="text-white text-[18px] lg:text-[20px] text-center mb-6 italic">
          ...
          {/* Two-Column Layout */}
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 max-w-[1200px] mx-auto relative">
            ...
            {/* Left Column: You Win */}
            <div>
              <h3 className="text-gold text-[28px] lg:text-[32px] font-serif italic mb-8">
                You Win
              </h3>
          ...
          <p className="text-gold text-[18px] lg:text-[20px] text-center mt-16 font-serif italic font-semibold">
      ...
      >
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-8 lg:px-16">
          ...
          <div className="text-center mb-8 lg:mb-10">
            <h2 className="text-gold text-[42px] lg:text-[48px] xl:text-[52px] font-serif italic mb-2">
              Built-In Protection for Long-Term Confidence
            </h2>
            <p className="text-white text-[19px] lg:text-[21px] xl:text-[23px]">
              Protection That Goes Beyond the Purchase
            </p>
          </div>

          {/* Main Content - Shield and Benefits */}
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 items-start lg:items-center mb-10 lg:mb-12">
          ...
          <div className="text-center max-w-[900px] mx-auto">
            <h3 className="text-gold text-[32px] lg:text-[38px] xl:text-[42px] font-serif italic mb-3">
              Confidence After You Own
            </h3>
            <p className="text-white text-[17px] lg:text-[19px] leading-relaxed mb-6">
            ...
            <a
              id="schedule"
              href="/get-started"
              className="inline-block bg-cta-red text-white text-[14px] lg:text-[15px] font-semibold px-6 lg:px-7 py-3.5 lg:py-4 rounded-[6px] mb-4 hover:bg-red-700 transition-colors duration-200 leading-tight"
            >
              Get Started
            </a>

            <p className="text-white/70 text-[14px] lg:text-[15px] mb-6 italic">
              No obligation. Just clarity.
            </p>

            {/* Disclaimer */}
            <p className="text-white/60 text-[12px] lg:text-[13px] leading-relaxed italic">
